...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <img class="  w-full h-72 object-fill rounded-t-sm" src={recipe.coverimg} alt="" />
    
    <div class="p-5">
        
    <div className="flex justify-between items-center"> {/* Wrap both title and icon in a flex container */}
  ...
  {recipe.isveg ? (
    ...
    />
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-orange-300">{description} </p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Region : {mainregion.map((val,i)=>{
