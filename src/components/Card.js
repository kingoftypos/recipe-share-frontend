...
<div class="w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <img class="  w-full h-52 object-fill rounded-t-sm" src={recipe.coverimg} alt="" />
  ...
  {recipe.isveg ? (
    ...
    />
            ...
            <p class="mb-3 text-xs text-gray-700 dark:text-orange-300">{description} </p>
        <p class="mb-3 text-xs text-gray-700 dark:text-gray-400">Region : {mainregion.map((val,i)=>{
